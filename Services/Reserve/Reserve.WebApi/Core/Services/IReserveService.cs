...
namespace ReservService
{
	public interface IReserveService
    {
		...
		public Task<IReadOnlyList<Reserve>> GetReservesByUserId(Guid userId, CancellationToken ct);
        public Task<IReadOnlyList<Reserve>> GetReservesByHotelId(Guid hotelId, CancellationToken ct);
        public Task<IReadOnlyList<Reserve>> GetReservesByRoomId(Guid roomId, CancellationToken ct);
